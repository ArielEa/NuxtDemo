...
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttr, ssrInterpolate, ssrRenderList, ssrRenderStyle } from 'vue/server-renderer';
...
const ant_design_vue_msXBSzokrX = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const _sfc_main$3 = {
  ...
  data() {
    return {
      ...
      page: 1,
      // Track the current page for loading more data
      pageSize: 3
  ...
  methods: {
    ...
    handleScroll() {
      const scrollTop = (void 0).pageYOffset || (void 0).documentElement.scrollTop || (void 0).body.scrollTop;
      const scrollHeight = (void 0).documentElement.scrollHeight;
      const clientHeight = (void 0).innerHeight || (void 0).documentElement.clientHeight || (void 0).body.clientHeight;
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(ssrRenderComponent(_component_a_input_search, {
                      value: $data.value,
                      "onUpdate:value": ($event) => $data.value = $event,
  ...
  _push(`</div><div class="list-container">`);
  _push(ssrRenderComponent(_component_a_list, {
    ...
    renderItem: withCtx(({ item }, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_a_list_item, { key: "item.title" }, createSlots({
          extra: withCtx((_, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              ...
              return [
                !$data.loading ? (openBlock(), createBlock("img", {
                  key: 0,
                  width: "272",
                  alt: "logo",
                  ...
                  if (_push4) {
                    _push4(ssrRenderComponent(_component_a_list_item_meta, {
                      ...
                      title: withCtx((_3, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          _push5(`<a${ssrRenderAttr("href", item.href)}${_scopeId4}>${ssrInterpolate(item.title)}</a>`);
                        } else {
                          return [
                            createVNode("a", {
                              href: item.href
                      ...
                      avatar: withCtx((_3, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
          ...
          !$data.loading ? {
            ...
            fn: withCtx((_, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(`<!--[-->`);
                ssrRenderList(item.actions, ({ icon, text }, index) => {
                  _push3(`<span${_scopeId2}>`);
                  ssrRenderVNode(_push3, createVNode(resolveDynamicComponent(icon), { style: { "margin-right": "8px" } }, null), _parent3, _scopeId2);
                  _push3(` ${ssrInterpolate(text)}</span>`);
                });
                _push3(`<!--]-->`);
              } else {
                return [
                  (openBlock(true), createBlock(Fragment, null, renderList(item.actions, ({ icon, text }, index) => {
                    return openBlock(), createBlock("span", { key: index }, [
                      (openBlock(), createBlock(resolveDynamicComponent(icon), { style: { "margin-right": "8px" } })),
        ...
        return [
          createVNode(_component_a_list_item, { key: "item.title" }, createSlots({
            extra: withCtx(() => [
              !$data.loading ? (openBlock(), createBlock("img", {
                key: 0,
                width: "272",
  ...
  if ($data.listData.length > 0) {
    _push(`<div style="${ssrRenderStyle({ "text-align": "center", "margin-top": "20px" })}">`);
    if (!$data.loading) {
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("views/desktop/home.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const HomePage = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$1]]);
const _sfc_main$2 = {
  name: "App",
  components: {
    HomePage
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-B9Tl8Weq.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-zf33RuTq.mjs'));
